...
(2, 'uno', '$2a$10$x1/8kTsVlNtfNDpSmkLs0eXvgkTB5YLPXIn7FvZtXaWEO6YzcOSF2', '1@1.es', 'uno', 'none', NULL),
(3, 'dos', '$2a$10$XpxNWmS5qJUMg11uI4HcAuJdc7IkC1SQNFN5GM5xLiKlMa3uH7QOG', '2@2.es', 'dos', 'none', 'abe35bc2-558f-4fde-bd87-780f7511fa8e.jpg'),
...
(15, 'Ordenador', 'laptop', ''),
(16, 'Tenedor', 'de estos', ''),
(17, 'otra cosita', 'que no se que es', '');
...
INSERT INTO `partidasenjuego` (`id_partida`, `id_jugador`, `id_victima`, `id_objeto`, `asesinatos`, `ticket`, `victima_killed`, `fecha_asesinato`) VALUES
(1, 1, 2, 9, 0, 1, 0, NULL),
(1, 2, 3, 10, 0, 1, 0, NULL),
(1, 3, 4, 11, 0, 0, 0, NULL),
(1, 4, 1, 13, 1, 0, 1, '2023-09-24'),
(2, 1, 3, 15, 0, 0, 0, NULL),
(2, 3, 4, 16, 0, 0, 0, NULL),
(2, 4, 1, 17, 0, 0, 0, NULL);
